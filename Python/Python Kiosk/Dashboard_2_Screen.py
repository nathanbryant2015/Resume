...
Screen_2_Postion_start = config['dashboard_screen_2_start']
...
#Open chrome and go to google_login for driver 1
...
#update driver options for driver 2
options.add_argument(Screen_2_Postion_start)
driver2 = webdriver.Chrome(executable_path=chromedriver_path, options=options)


#Open chrome and go to google_login for driver 2
driver2.get(config['google_login'])
#sleep to load page
time.sleep(3)
#Find field to input email
email_field = driver2.find_element(By.CSS_SELECTOR, 'input[type="email"]')
email_field.send_keys(email)
#Click the next button
next_button = driver2.find_element(By.CSS_SELECTOR, "#identifierNext")
next_button.click()
#sleep to load page
time.sleep(3)
#Find and enter password
password_field = driver2.find_element(By.CSS_SELECTOR, 'input[type="password"]')
password_field.send_keys(password)
#click login
login_button = driver2.find_element(By.CSS_SELECTOR, "#passwordNext")
login_button.click()
time.sleep(3)
...
while True:
    ...
    driver2.get(config['chrome_url02'])
    time.sleep(60 * 60)